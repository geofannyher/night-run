...
const Footer = () => {
  ...
  return (
    <footer className="bg-vibrant-lime" role="contentinfo">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-1">
          ...
          <div>
            ...
            <p className="text0gblack/80 text-sm leading-relaxed mb-4">
              Jl. Sudarman, Alun-alun Kabupaten Jember
              <br />
              Indonesia 68118
            </p>
            <div className="flex items-center gap-2 text-sm text0gblack/80">
        ...
        {/* Bottom bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text0gblack/80">
